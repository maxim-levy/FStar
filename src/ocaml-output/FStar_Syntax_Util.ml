  ...
  fun t  ->
    ...
    | (head1,args) ->
        ...
        (match uu____6432 with
         ...
         | uu____6513 -> FStar_Pervasives_Native.None)
...
let (is_auto_squash :
  ...
  =
  fun t  ->
    let uu____6543 = head_and_args t  in
    match uu____6543 with
    | (head1,args) ->
        let uu____6588 =
          let uu____6601 =
            let uu____6602 = FStar_Syntax_Subst.compress head1  in
        ...
        (match uu____6588 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____6623;_},u::[]),(t1,uu____6626)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.auto_squash_lid
             -> FStar_Pervasives_Native.Some (u, t1)
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____6691 = let uu____6706 = unmeta t  in head_and_args uu____6706
       in
    match uu____6691 with
    | (head1,uu____6708) ->
        let uu____6729 =
          let uu____6730 = un_uinst head1  in
...
let (arrow_one :
  ...
  fun t  ->
    let uu____6750 =
      let uu____6763 =
        let uu____6764 = FStar_Syntax_Subst.compress t  in
      ...
      | FStar_Syntax_Syntax.Tm_arrow (b::bs,c) ->
          let uu____6873 =
            let uu____6882 =
              let uu____6883 = arrow bs c  in
              FStar_Syntax_Syntax.mk_Total uu____6883  in
            (b, uu____6882)  in
          FStar_Pervasives_Native.Some uu____6873
      | uu____6896 -> FStar_Pervasives_Native.None  in
    FStar_Util.bind_opt uu____6750
      (fun uu____6932  ->
         match uu____6932 with
         | (b,c) ->
             let uu____6967 = FStar_Syntax_Subst.open_comp [b] c  in
...
let (is_free_in :
  ...
  fun bv  ->
    fun t  ->
      let uu____7037 = FStar_Syntax_Free.names t  in
      FStar_Util.set_mem bv uu____7037
...
let (uu___is_QAll : connective -> Prims.bool) =
  fun projectee  ->
    match projectee with | QAll _0 -> true | uu____7080 -> false
...
let (uu___is_QEx : connective -> Prims.bool) =
  fun projectee  ->
    match projectee with | QEx _0 -> true | uu____7116 -> false
...
let (uu___is_BaseConn : connective -> Prims.bool) =
  fun projectee  ->
    match projectee with | BaseConn _0 -> true | uu____7150 -> false
...
let (destruct_typ_as_formula :
  ...
  fun f  ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic uu____7183) -> unmeta_monadic t
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic_lift uu____7195) ->
          unmeta_monadic t
      | uu____7208 -> f2  in
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____7286 =
        match uu____7286 with
        | (lid,arity) ->
            let uu____7295 =
              let uu____7310 = unmeta_monadic f2  in head_and_args uu____7310
               in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu____7411 = FStar_Syntax_Subst.compress t2  in
          (pats, uu____7411)
      | uu____7422 -> ([], t1)  in
    let destruct_q_conn t =
      let is_q fa fv =
        ...
        then is_forall (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
         ...
         in
      let flat t1 =
        let uu____7469 = head_and_args t1  in
        match uu____7469 with
        | (t2,args) ->
            let uu____7516 = un_uinst t2  in
            let uu____7517 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____7550  ->
                      ...
                      | (t3,imp) ->
                          let uu____7561 = unascribe t3  in (uu____7561, imp)))
               in
            (uu____7516, uu____7517)
         in
      let rec aux qopt out t1 =
        let uu____7596 = let uu____7613 = flat t1  in (qopt, uu____7613)  in
           ...
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 ...
                 FStar_Syntax_Syntax.vars = uu____7641;_},({
                                                             ...
                                                             FStar_Syntax_Syntax.pos
                                                               = uu____7645;
                                                             FStar_Syntax_Syntax.vars
                                                               = uu____7646;_},uu____7647)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.pos = uu____7732;
                 FStar_Syntax_Syntax.vars = uu____7733;_},uu____7734::
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____7737);
                  FStar_Syntax_Syntax.pos = uu____7738;
                  FStar_Syntax_Syntax.vars = uu____7739;_},uu____7740)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.pos = uu____7836;
               FStar_Syntax_Syntax.vars = uu____7837;_},({
                                                           FStar_Syntax_Syntax.n
                                                             =
                                                             FStar_Syntax_Syntax.Tm_abs
                                                             (b::[],t2,uu____7840);
        ...
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.pos = uu____7927;
               FStar_Syntax_Syntax.vars = uu____7928;_},uu____7929::({
                                                                    FStar_Syntax_Syntax.n
                                                                    =
                                                                    FStar_Syntax_Syntax.Tm_abs
                                                                    (b::[],t2,uu____7932);
            ...
            aux
              (FStar_Pervasives_Native.Some
                 (is_forall
                    (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v))
              (b :: out) t2
        | (FStar_Pervasives_Native.Some b,uu____8031) ->
            let bs = FStar_List.rev out  in
            let uu____8065 = FStar_Syntax_Subst.open_term bs t1  in
            (match uu____8065 with
             | (bs1,t2) ->
                 let uu____8074 = patterns t2  in
        ...
        | uu____8136 -> FStar_Pervasives_Native.None  in
    ...
    let destruct_sq_base_conn t =
      let uu____8202 = un_squash t  in
      FStar_Util.bind_opt uu____8202
        (fun t1  ->
           let uu____8218 = head_and_args' t1  in
           match uu____8218 with
           | (hd1,args) ->
               let uu____8251 =
                 let uu____8256 =
                   let uu____8257 = un_uinst hd1  in
                   uu____8257.FStar_Syntax_Syntax.n  in
                 (uu____8256, (FStar_List.length args))  in
    ...
    let rec destruct_sq_forall t =
      let uu____8363 = un_squash t  in
      FStar_Util.bind_opt uu____8363
        (fun t1  ->
           let uu____8378 = arrow_one t1  in
           match uu____8378 with
           | FStar_Pervasives_Native.Some (b,c) ->
               let uu____8393 =
                 let uu____8394 = is_tot_or_gtot_comp c  in
                 Prims.op_Negation uu____8394  in
               if uu____8393
               then FStar_Pervasives_Native.None
               else
                 (let q =
                    let uu____8401 = comp_to_comp_typ c  in
                    uu____8401.FStar_Syntax_Syntax.result_typ  in
                  let uu____8402 =
                    is_free_in (FStar_Pervasives_Native.fst b) q  in
                  if uu____8402
                  then
                    let uu____8405 = patterns q  in
                         ...
                         let uu____8467 =
                           let uu____8470 =
                             FStar_Syntax_Syntax.as_arg
                              ...
                              in
                           let uu____8471 =
                             let uu____8474 = FStar_Syntax_Syntax.as_arg q
                                in
                             [uu____8474]  in
                           uu____8470 :: uu____8471  in
                         (FStar_Parser_Const.imp_lid, uu____8467)  in
                       BaseConn uu____8462  in
                     FStar_Pervasives_Native.Some uu____8461))
           | uu____8477 -> FStar_Pervasives_Native.None)
    
    and destruct_sq_exists t =
      let uu____8485 = un_squash t  in
      FStar_Util.bind_opt uu____8485
        (fun t1  ->
           let uu____8516 = head_and_args' t1  in
           match uu____8516 with
           | (hd1,args) ->
               let uu____8549 =
                 let uu____8562 =
                   let uu____8563 = un_uinst hd1  in
                   uu____8563.FStar_Syntax_Syntax.n  in
                 (uu____8562, args)  in
               (match uu____8549 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu____8578)::(a2,uu____8580)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                      FStar_Parser_Const.dtuple2_lid
                    ->
                    let uu____8615 =
                      let uu____8616 = FStar_Syntax_Subst.compress a2  in
                      uu____8616.FStar_Syntax_Syntax.n  in
                    (match uu____8615 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____8623) ->
                         let uu____8650 = FStar_Syntax_Subst.open_term [b] q
                            in
                         (match uu____8650 with
                          | (bs,q1) ->
                              let b1 =
                                match bs with
                                | b1::[] -> b1
                                | uu____8689 -> failwith "impossible"  in
                              let uu____8694 = patterns q1  in
                              (match uu____8694 with
                               | (pats,q2) ->
                                   FStar_All.pipe_left maybe_collect
                                     (FStar_Pervasives_Native.Some
                                        (QEx ([b1], pats, q2)))))
                     | uu____8761 -> FStar_Pervasives_Native.None)
                | uu____8762 -> FStar_Pervasives_Native.None))
    
    and maybe_collect f1 =
      match f1 with
      | FStar_Pervasives_Native.Some (QAll (bs,pats,phi)) ->
          let uu____8783 = destruct_sq_forall phi  in
      ...
      | FStar_Pervasives_Native.Some (QEx (bs,pats,phi)) ->
          let uu____8811 = destruct_sq_exists phi  in
    ...
    let uu____8840 = destruct_base_conn phi  in
    FStar_Util.catch_opt uu____8840
      (fun uu____8845  ->
         let uu____8846 = destruct_q_conn phi  in
         FStar_Util.catch_opt uu____8846
           (fun uu____8851  ->
              let uu____8852 = destruct_sq_base_conn phi  in
              FStar_Util.catch_opt uu____8852
                (fun uu____8857  ->
                   let uu____8858 = destruct_sq_forall phi  in
                   FStar_Util.catch_opt uu____8858
                     (fun uu____8863  ->
                        let uu____8864 = destruct_sq_exists phi  in
                        FStar_Util.catch_opt uu____8864
                          (fun uu____8868  -> FStar_Pervasives_Native.None)))))
...
let (unthunk_lemma_post :
  ...
  fun t  ->
    let uu____8874 =
      let uu____8875 = FStar_Syntax_Subst.compress t  in
      uu____8875.FStar_Syntax_Syntax.n  in
    match uu____8874 with
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____8882) ->
        let uu____8909 = FStar_Syntax_Subst.open_term [b] e  in
        (match uu____8909 with
         | (bs,e1) ->
             let b1 = FStar_List.hd bs  in
             let uu____8935 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____8935
             then
               let uu____8938 =
                 let uu____8947 = FStar_Syntax_Syntax.as_arg exp_unit  in
                 [uu____8947]  in
               mk_app t uu____8938
             else e1)
    | uu____8949 ->
        let uu____8950 =
          let uu____8959 = FStar_Syntax_Syntax.as_arg exp_unit  in
          [uu____8959]  in
        mk_app t uu____8950
          ...
          let uu____8970 =
            let uu____8975 =
              FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name
                ...
                FStar_Pervasives_Native.None
               in
            FStar_Util.Inr uu____8975  in
          let uu____8976 =
            let uu____8977 =
              FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ
               in
            arrow a.FStar_Syntax_Syntax.action_params uu____8977  in
          let uu____8980 =
            abs a.FStar_Syntax_Syntax.action_params
              a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None
             in
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            uu____8970 a.FStar_Syntax_Syntax.action_univs uu____8976
            FStar_Parser_Const.effect_Tot_lid uu____8980 [] pos
           in
        {
  ...
  fun t  ->
    ...
    let uu____9007 =
      let uu____9010 =
        let uu____9011 =
          let uu____9026 =
            let uu____9029 = FStar_Syntax_Syntax.as_arg t  in [uu____9029]
             in
          (reify_, uu____9026)  in
        FStar_Syntax_Syntax.Tm_app uu____9011  in
      FStar_Syntax_Syntax.mk uu____9010  in
    uu____9007 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
...
let rec (delta_qualifier :
  ...
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t  in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____9041 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_lazy i ->
        let uu____9067 = unfold_lazy i  in delta_qualifier uu____9067
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____9069 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____9070 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____9071 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____9094 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____9111 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____9112 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____9113 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____9127) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____9132;
           FStar_Syntax_Syntax.index = uu____9133;
           FStar_Syntax_Syntax.sort = t2;_},uu____9135)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____9143) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____9149,uu____9150) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____9192) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____9213,t2,uu____9215) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____9236,t2) -> delta_qualifier t2
...
let (incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth) =
  fun t  ->
    let uu____9262 = delta_qualifier t  in incr_delta_depth uu____9262
  
let (is_unknown : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____9266 =
      let uu____9267 = FStar_Syntax_Subst.compress t  in
...
let rec (list_elements :
  ...
  =
  fun e  ->
    let uu____9282 = let uu____9297 = unmeta e  in head_and_args uu____9297
       in
    match uu____9282 with
    | (head1,args) ->
        let uu____9324 =
          let uu____9337 =
            let uu____9338 = un_uinst head1  in
            uu____9338.FStar_Syntax_Syntax.n  in
          (uu____9337, args)  in
        (match uu____9324 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____9354) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____9374::(hd1,uu____9376)::(tl1,uu____9378)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
             let uu____9425 =
               let uu____9430 =
                 let uu____9435 = list_elements tl1  in
                 FStar_Util.must uu____9435  in
               hd1 :: uu____9430  in
             FStar_Pervasives_Native.Some uu____9425
         | uu____9448 -> FStar_Pervasives_Native.None)
  
let rec apply_last :
  'Auu____9466 .
    ('Auu____9466 -> 'Auu____9466) ->
      'Auu____9466 Prims.list -> 'Auu____9466 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
      | [] -> failwith "apply_last: got empty list"
      | a::[] -> let uu____9489 = f a  in [uu____9489]
      | x::xs -> let uu____9494 = apply_last f xs  in x :: uu____9494
            ...
            let uu____9533 =
              let uu____9534 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  ...
                  (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor)
                 in
              FStar_Syntax_Syntax.Tm_fvar uu____9534  in
            FStar_Syntax_Syntax.mk uu____9533  in
          uu____9530 FStar_Pervasives_Native.None rng  in
        let cons1 args pos =
          let uu____9547 =
            let uu____9548 =
              let uu____9549 = ctor FStar_Parser_Const.cons_lid  in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____9549
                [FStar_Syntax_Syntax.U_zero]
               in
            FStar_Syntax_Syntax.mk_Tm_app uu____9548 args  in
          uu____9547 FStar_Pervasives_Native.None pos  in
        let nil args pos =
          let uu____9561 =
            let uu____9562 =
              let uu____9563 = ctor FStar_Parser_Const.nil_lid  in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____9563
                [FStar_Syntax_Syntax.U_zero]
               in
            FStar_Syntax_Syntax.mk_Tm_app uu____9562 args  in
          uu____9561 FStar_Pervasives_Native.None pos  in
        let uu____9566 =
          let uu____9567 =
            let uu____9568 = FStar_Syntax_Syntax.iarg typ  in [uu____9568]
             in
          nil uu____9567 rng  in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____9574 =
                 let uu____9575 = FStar_Syntax_Syntax.iarg typ  in
                 let uu____9576 =
                   let uu____9579 = FStar_Syntax_Syntax.as_arg t  in
                   let uu____9580 =
                     let uu____9583 = FStar_Syntax_Syntax.as_arg a  in
                     [uu____9583]  in
                   uu____9579 :: uu____9580  in
                 uu____9575 :: uu____9576  in
               cons1 uu____9574 t.FStar_Syntax_Syntax.pos) l uu____9566
  ...
  fun id1  ->
    fun t  ->
      let uu____9592 =
        let uu____9595 =
          let uu____9596 =
            let uu____9613 = FStar_Syntax_Unionfind.from_id id1  in
            (uu____9613, t)  in
          FStar_Syntax_Syntax.Tm_uvar uu____9596  in
        FStar_Syntax_Syntax.mk uu____9595  in
      uu____9592 FStar_Pervasives_Native.None FStar_Range.dummyRange
  ...
  fun msg  ->
    fun cond  ->
      ...
      then true
        ...
        ((let uu____9938 = FStar_ST.op_Bang debug_term_eq  in
          if uu____9938
...
let rec (term_eq_dbg :
  ...
  fun dbg  ->
    fun t1  ->
      fun t2  ->
        let t11 = let uu____10070 = unmeta_safe t1  in canon_app uu____10070
           in
        let t21 = let uu____10074 = unmeta_safe t2  in canon_app uu____10074
           in
        let uu____10075 =
          let uu____10080 =
            let uu____10081 =
              let uu____10084 = un_uinst t11  in
              FStar_Syntax_Subst.compress uu____10084  in
            uu____10081.FStar_Syntax_Syntax.n  in
          let uu____10085 =
            let uu____10086 =
              let uu____10089 = un_uinst t21  in
              FStar_Syntax_Subst.compress uu____10089  in
            uu____10086.FStar_Syntax_Syntax.n  in
          (uu____10080, uu____10085)  in
        ...
        | (uu____10098,FStar_Syntax_Syntax.Tm_uinst uu____10099) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_delayed uu____10106,uu____10107) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____10132,FStar_Syntax_Syntax.Tm_delayed uu____10133) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_ascribed uu____10158,uu____10159) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____10186,FStar_Syntax_Syntax.Tm_ascribed uu____10187) ->
            failwith "term_eq: impossible, should have been removed"
        ...
        | (FStar_Syntax_Syntax.Tm_fvar x,FStar_Syntax_Syntax.Tm_fvar y) ->
            let uu____10220 = FStar_Syntax_Syntax.fv_eq x y  in
            check "fvar" uu____10220
        | (FStar_Syntax_Syntax.Tm_constant c1,FStar_Syntax_Syntax.Tm_constant
           c2) ->
            let uu____10223 = FStar_Const.eq_const c1 c2  in
            check "const" uu____10223
        | (FStar_Syntax_Syntax.Tm_type
           uu____10224,FStar_Syntax_Syntax.Tm_type uu____10225) -> true
        | (FStar_Syntax_Syntax.Tm_abs (b1,t12,k1),FStar_Syntax_Syntax.Tm_abs
           (b2,t22,k2)) ->
            (let uu____10274 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "abs binders" uu____10274) &&
              (let uu____10280 = term_eq_dbg dbg t12 t22  in
               check "abs bodies" uu____10280)
        | (FStar_Syntax_Syntax.Tm_arrow (b1,c1),FStar_Syntax_Syntax.Tm_arrow
           (b2,c2)) ->
            (let uu____10319 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "arrow binders" uu____10319) &&
              (let uu____10325 = comp_eq_dbg dbg c1 c2  in
               check "arrow comp" uu____10325)
        | (FStar_Syntax_Syntax.Tm_refine
           (b1,t12),FStar_Syntax_Syntax.Tm_refine (b2,t22)) ->
            (check "refine bv"
               (b1.FStar_Syntax_Syntax.index = b2.FStar_Syntax_Syntax.index))
              &&
              (let uu____10339 = term_eq_dbg dbg t12 t22  in
               check "refine formula" uu____10339)
        | (FStar_Syntax_Syntax.Tm_app (f1,a1),FStar_Syntax_Syntax.Tm_app
           (f2,a2)) ->
            (let uu____10386 = term_eq_dbg dbg f1 f2  in
             check "app head" uu____10386) &&
              (let uu____10388 = eqlist (arg_eq_dbg dbg) a1 a2  in
               check "app args" uu____10388)
        | (FStar_Syntax_Syntax.Tm_match
           (t12,bs1),FStar_Syntax_Syntax.Tm_match (t22,bs2)) ->
            (let uu____10473 = term_eq_dbg dbg t12 t22  in
             check "match head" uu____10473) &&
              (let uu____10475 = eqlist (branch_eq_dbg dbg) bs1 bs2  in
               check "match branches" uu____10475)
        | (FStar_Syntax_Syntax.Tm_lazy uu____10490,uu____10491) ->
            let uu____10492 =
              let uu____10493 = unlazy t11  in
              term_eq_dbg dbg uu____10493 t21  in
            check "lazy_l" uu____10492
        | (uu____10494,FStar_Syntax_Syntax.Tm_lazy uu____10495) ->
            let uu____10496 =
              let uu____10497 = unlazy t21  in
              term_eq_dbg dbg t11 uu____10497  in
            check "lazy_r" uu____10496
        | (FStar_Syntax_Syntax.Tm_let
           ((b1,lbs1),t12),FStar_Syntax_Syntax.Tm_let ((b2,lbs2),t22)) ->
            ((check "let flag" (b1 = b2)) &&
               (let uu____10533 = eqlist (letbinding_eq_dbg dbg) lbs1 lbs2
                   in
                check "let lbs" uu____10533))
              &&
              (let uu____10535 = term_eq_dbg dbg t12 t22  in
               check "let body" uu____10535)
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu____10537),FStar_Syntax_Syntax.Tm_uvar (u2,uu____10539)) ->
            check "uvar" (u1 = u2)
             ...
             | (FStar_Syntax_Syntax.Meta_monadic
                (n1,ty1),FStar_Syntax_Syntax.Meta_monadic (n2,ty2)) ->
                 (check "meta_monadic lid" (FStar_Ident.lid_equals n1 n2)) &&
                   (let uu____10623 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic type" uu____10623)
             | (FStar_Syntax_Syntax.Meta_monadic_lift
                ...
                (s2,t23,ty2)) ->
                 ((check "meta_monadic_lift src"
                   ...
                   &&
                   (let uu____10639 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic_lift type" uu____10639)
             | (FStar_Syntax_Syntax.Meta_quoted
                (qt1,qi1),FStar_Syntax_Syntax.Meta_quoted (qt2,qi2)) ->
                 (check "meta_quoted dyn" (qi1 = qi2)) &&
                   (let uu____10653 = term_eq_dbg dbg qt1 qt2  in
                    check "meta_quoted payload" uu____10653)
             | uu____10654 -> fail "metas")
        | (FStar_Syntax_Syntax.Tm_unknown ,uu____10659) -> fail "unk"
        | (uu____10660,FStar_Syntax_Syntax.Tm_unknown ) -> fail "unk"
        | (FStar_Syntax_Syntax.Tm_bvar uu____10661,uu____10662) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_name uu____10663,uu____10664) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_fvar uu____10665,uu____10666) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_constant uu____10667,uu____10668) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_type uu____10669,uu____10670) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_abs uu____10671,uu____10672) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_arrow uu____10689,uu____10690) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_refine uu____10703,uu____10704) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_app uu____10711,uu____10712) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_match uu____10727,uu____10728) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_let uu____10751,uu____10752) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_uvar uu____10765,uu____10766) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_meta uu____10783,uu____10784) ->
            fail "bottom"
        | (uu____10791,FStar_Syntax_Syntax.Tm_bvar uu____10792) ->
            fail "bottom"
        | (uu____10793,FStar_Syntax_Syntax.Tm_name uu____10794) ->
            fail "bottom"
        | (uu____10795,FStar_Syntax_Syntax.Tm_fvar uu____10796) ->
            fail "bottom"
        | (uu____10797,FStar_Syntax_Syntax.Tm_constant uu____10798) ->
            fail "bottom"
        | (uu____10799,FStar_Syntax_Syntax.Tm_type uu____10800) ->
            fail "bottom"
        | (uu____10801,FStar_Syntax_Syntax.Tm_abs uu____10802) ->
            fail "bottom"
        | (uu____10819,FStar_Syntax_Syntax.Tm_arrow uu____10820) ->
            fail "bottom"
        | (uu____10833,FStar_Syntax_Syntax.Tm_refine uu____10834) ->
            fail "bottom"
        | (uu____10841,FStar_Syntax_Syntax.Tm_app uu____10842) ->
            fail "bottom"
        | (uu____10857,FStar_Syntax_Syntax.Tm_match uu____10858) ->
            fail "bottom"
        | (uu____10881,FStar_Syntax_Syntax.Tm_let uu____10882) ->
            fail "bottom"
        | (uu____10895,FStar_Syntax_Syntax.Tm_uvar uu____10896) ->
            fail "bottom"
        | (uu____10913,FStar_Syntax_Syntax.Tm_meta uu____10914) ->
            fail "bottom"
    ...
    fun a1  ->
      fun a2  ->
        eqprod
          (fun t1  ->
             fun t2  ->
               let uu____10941 = term_eq_dbg dbg t1 t2  in
               check "arg tm" uu____10941)
        ...
        ((check "comp eff"
           ...
           (let uu____10981 =
              term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ
               ...
               in
            check "comp result typ" uu____10981))
          && true
  ...
  fun dbg  ->
    fun uu____10986  ->
      fun uu____10987  ->
        ...
        | ((p1,w1,t1),(p2,w2,t2)) ->
            ((let uu____11112 = FStar_Syntax_Syntax.eq_pat p1 p2  in
              check "branch pat" uu____11112) &&
               (let uu____11114 = term_eq_dbg dbg t1 t2  in
                check "branch body" uu____11114))
              &&
              (let uu____11116 =
                 match (w1, w2) with
                 | (FStar_Pervasives_Native.Some
      ...
      fun lb2  ->
        ((let uu____11173 =
            eqsum (fun bv1  -> fun bv2  -> true) FStar_Syntax_Syntax.fv_eq
             ...
             in
          check "lb bv" uu____11173) &&
           (let uu____11179 =
              term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp
                lb2.FStar_Syntax_Syntax.lbtyp
               in
            check "lb typ" uu____11179))
          &&
          (let uu____11181 =
             term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef
               lb2.FStar_Syntax_Syntax.lbdef
              in
           check "lb def" uu____11181)
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let r =
        let uu____11189 = FStar_ST.op_Bang debug_term_eq  in
        term_eq_dbg uu____11189 t1 t2  in
...
let rec (bottom_fold :
  ...
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____11244 = FStar_Syntax_Subst.compress t  in
        uu____11244.FStar_Syntax_Syntax.n  in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____11270 =
              let uu____11285 = ff f1  in
              let uu____11286 =
                FStar_List.map
                  (fun uu____11305  ->
                     match uu____11305 with
                     | (a,q) -> let uu____11316 = ff a  in (uu____11316, q))
                  args
                 in
              (uu____11285, uu____11286)  in
            FStar_Syntax_Syntax.Tm_app uu____11270
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____11346 = FStar_Syntax_Subst.open_term bs t1  in
            (match uu____11346 with
             | (bs1,t') ->
                 let t'' = ff t'  in
                 let uu____11354 =
                   let uu____11371 = FStar_Syntax_Subst.close bs1 t''  in
                   (bs1, uu____11371, k)  in
                 FStar_Syntax_Syntax.Tm_abs uu____11354)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
            let uu____11398 = let uu____11405 = ff t1  in (uu____11405, us)
               in
            FStar_Syntax_Syntax.Tm_uinst uu____11398
        | uu____11406 -> tn  in
      f
        (let uu___58_11409 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___58_11409.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___58_11409.FStar_Syntax_Syntax.vars)
         })
  
let rec (sizeof : FStar_Syntax_Syntax.term -> Prims.int) =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____11413 ->
        let uu____11438 =
          let uu____11439 = FStar_Syntax_Subst.compress t  in
          sizeof uu____11439  in
        (Prims.parse_int "1") + uu____11438
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____11441 = sizeof bv.FStar_Syntax_Syntax.sort  in
        (Prims.parse_int "1") + uu____11441
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____11443 = sizeof bv.FStar_Syntax_Syntax.sort  in
        (Prims.parse_int "1") + uu____11443
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____11450 = sizeof t1  in (FStar_List.length us) + uu____11450
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____11453) ->
        let uu____11474 = sizeof t1  in
        let uu____11475 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____11486  ->
                 ...
                 | (bv,uu____11492) ->
                     let uu____11493 = sizeof bv.FStar_Syntax_Syntax.sort  in
                     acc + uu____11493) (Prims.parse_int "0") bs
           in
        uu____11474 + uu____11475
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____11516 = sizeof hd1  in
        let uu____11517 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____11528  ->
                 ...
                 | (arg,uu____11534) ->
                     let uu____11535 = sizeof arg  in acc + uu____11535)
            (Prims.parse_int "0") args
           in
        uu____11516 + uu____11517
    | uu____11536 -> (Prims.parse_int "1")
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____11543 =
        let uu____11544 = un_uinst t  in uu____11544.FStar_Syntax_Syntax.n
         in
  ...
  fun p  ->
    fun r  ->
      let set_options1 t s =
        let uu____11575 = FStar_Options.set_options t s  in
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____11583 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____11583 FStar_Pervasives.ignore);
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
