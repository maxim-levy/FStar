            ...
            (let uu___402_55 = env  in
             {
               ...
               FStar_TypeChecker_Env.weaken_comp_tys =
                 (uu___402_55.FStar_TypeChecker_Env.weaken_comp_tys);
  ...
  fun deps  ->
    ...
    let env1 =
      let uu___404_253 = env  in
      {
        ...
        FStar_TypeChecker_Env.weaken_comp_tys =
          (uu___404_253.FStar_TypeChecker_Env.weaken_comp_tys);
        FStar_TypeChecker_Env.tc_term =
    ...
    let env2 =
      let uu___405_255 = env1  in
      {
        ...
        FStar_TypeChecker_Env.weaken_comp_tys =
          (uu___405_255.FStar_TypeChecker_Env.weaken_comp_tys);
        FStar_TypeChecker_Env.tc_term =
    ...
    let env3 =
      let uu___406_257 = env2  in
      {
        ...
        FStar_TypeChecker_Env.weaken_comp_tys =
          (uu___406_257.FStar_TypeChecker_Env.weaken_comp_tys);
        FStar_TypeChecker_Env.tc_term =
