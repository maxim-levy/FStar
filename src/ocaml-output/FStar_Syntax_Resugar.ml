...
let (string_to_op :
  ...
  =
  fun s  ->
    let name_of_op uu___189_449 =
      match uu___189_449 with
      | "Amp" ->
          FStar_Pervasives_Native.Some ("&", FStar_Pervasives_Native.None)
      | "At" ->
          FStar_Pervasives_Native.Some ("@", FStar_Pervasives_Native.None)
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
          ...
          (match uu____1624 with
           | (xs1,body1) ->
               ...
               let rec aux body3 uu___190_1667 =
                 match uu___190_1667 with
                 | [] -> body3
                 | hd1::tl1 ->
                     let body4 =
      ...
      | FStar_Syntax_Syntax.Tm_app (e,args) ->
          let rec last1 uu___191_1799 =
            match uu___191_1799 with
            | hd1::[] -> [hd1]
            | hd1::tl1 -> last1 tl1
            | uu____1869 -> failwith "last of an empty list"  in
          let rec last_two uu___192_1907 =
            match uu___192_1907 with
            | [] ->
                failwith
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___193_4850 =
            match uu___193_4850 with
          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___194_5564 =
              match uu___194_5564 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
